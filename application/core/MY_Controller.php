...
class MY_Controller extends CI_Controller{	
    ...
    require(APPPATH.'/helpers/Zumba/Util/JsonSerializer.php');
    require(APPPATH.'/helpers/Zumba/Exception/JsonSerializerException.php');
	...
	protected function _render($view,$renderData="FULLPAGE") {
		...
		if($this->ion_auth->logged_in()){
			...
			$toSide['moduli'] = $this->m_dashboard->getModule();
			$list_moduli = $this->m_dashboard->getModule();
			$toSide['sub'] = $this->m_dashboard->getSubModule($list_moduli);

			$toBody["leftbar"] = $this->load->view("template/leftbar",$toSide,true);
		}
